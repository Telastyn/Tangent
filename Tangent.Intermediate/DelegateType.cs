...
namespace Tangent.Intermediate
{
    public class DelegateType : TangentType
    {
        ...
        protected internal override IEnumerable<ParameterDeclaration> ContainedGenericReferences(HashSet<TangentType> alreadyProcessed)
        {
            ...
            var result = Takes.Aggregate(Enumerable.Empty<ParameterDeclaration>(), (a, t) => a.Concat(t.ContainedGenericReferences(alreadyProcessed))).ToList();
            result.AddRange(Returns.ContainedGenericReferences(alreadyProcessed));
            return result;
        }

...
namespace Tangent.Parsing.Partial
{
    public class PartialProductType : PartialClass
    {
        ...
        internal PartialProductType(IEnumerable<PartialPhrasePart> dataConstructorParts, IEnumerable<PartialReductionDeclaration> functions, IEnumerable<PartialParameterDeclaration> genericArgs, IEnumerable<TangentType> interfaceReferences)
